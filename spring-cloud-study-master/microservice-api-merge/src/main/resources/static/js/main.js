...
function initGreetingPage() {
    ...
    // initStatisticPage();
    // setTimeout(function() { initSavingsCircles(1, 0.2, 2, 3, 700) }, 200);
    // initSavingsSlider();
    // $("#savings-slider").data({"checkedPercent": 4});

    $("#lefttitle").append("<br>"+localStorage.getItem("nickname"));
    $("#righttitle").append("<br>"+localStorage.getItem("username"));
